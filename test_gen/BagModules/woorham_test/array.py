...
class woorham_mem__array(Module):
    """Module for library woorham_mem cell array.
    ...
    def design(self, n_word, n_bit):
        ...
        for i in range(n_bit):
            ...
            term_list.append({'t0': 'w%d<0:%d>'%(i, n_word-1), 't1': 'w%d<0:%d>'%(i+1, n_word-1), 'b0': 'b%d<%d:0>'%(i, n_word-1), 'b1': 'b%d<%d:1>'%(i, n_word)})
